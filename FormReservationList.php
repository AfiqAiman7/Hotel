	...
	<body>
		<header>
			...
			<ul class="menu">
				...
				<li><a href="#" onclick="toggleMenu();"><font color="black">Reservation List</font></a></li>
				<li><a href="FormRegisterBook.php" onclick="toggleMenu();">Add Room</a></li>
				<li><a href="FormBookList.php" onclick="toggleMenu();">Room List</font></a></li>
		...
		<div class="contactUs">
			<div class="title">
				<h2>Reservation List Database</h2>
			</div>
			<div class="box">
				<!-- Register Form -->
				<div class="contact form">
	                ...
	                <table bgcolor="black" align="center">
	                    ...
	                    <tr>
	                    	<td bgcolor="grey" align="center" width="15%">RESERVATION ID</td>
	                    ...
	                    <?php
	                        ...
	                        {
	                        	Print '<tr>
	                        	<td class="font" align="center">'.$list['Reservation_ID'].'</td>
	                            ...
	                            <td class="font" align="center">'.$list['Reservation_Status'].'</td>
	                            <td colspan="2">
	                                <a class="btn1" href="FormUpdateReservation.php?ID='.$list['Reservation_ID'].'">Update</a>
	                                <a class="btn2" href="FormDeleteReservation.php?ID='.$list['Reservation_ID'].'">Delete</a>
	                            </td>';
	                        }
	                    ?>
		...
		//JavaScript Auto Typing bagi class bernama typing//
			var typed = new Typed(".typing", {
				...
				strings: ["Reservation ID", "Member ID", "Room ID","Check In Date","Check Out Date", "Reservation_Status"],
				typeSpeed: 100,
				backSpeed: 60,
				loop: true
			});
